...
async def not_joined(client: Client, message: Message):
    ...
    if FORCE_SUB_CHANNEL1 and FORCE_SUB_CHANNEL2:
        buttons.append([
            InlineKeyboardButton(text="• ᴊᴏɪɴ ᴛᴇʟᴇɢʀᴀᴍ", url=client.invitelink1),
            InlineKeyboardButton(text="ᴊᴏɪɴ ᴛᴇʟᴇɢʀᴀᴍ •", url=client.invitelink2),
        ])
    ...
    if FORCE_SUB_CHANNEL3 and FORCE_SUB_CHANNEL4:
        buttons.append([
            InlineKeyboardButton(text="• ᴊᴏɪɴ ᴛᴇʟᴇɢʀᴀᴍ", url=client.invitelink3),
            InlineKeyboardButton(text="ᴊᴏɪɴ ᴛᴇʟᴇɢʀᴀᴍ •", url=client.invitelink4),
        ])
    # Check if only the first channel is set
